var Counter = React.createClass({
    ...
    componentWillUpdate: function() {
        console.log('componentWillUpdate // metoda zostanie wywoływana tylko do przygotowania na nadchodzące zmiany');
    },

    componentDidUpdate: function() {
        console.log('componentDidUpdate // po dokonaniu zmiany można wykonać różne operacje manipulacji');
    },
